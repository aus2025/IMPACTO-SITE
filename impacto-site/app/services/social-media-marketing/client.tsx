        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">
              Elevate your online presence with AI-powered content creation, audience targeting, and engagement strategies tailored for your business.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-xl p-8 shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600 mb-4">
                Generate engaging, on-brand content for multiple platforms with our AI-powered content creation tools that save time and increase consistency.
              </p>
              <ul className="space-y-2 mb-4">
                <li className="flex items-center">
                  ...
                  <span className="text-black">Customized Content Templates</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-black">Multi-Platform Formatting</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-black">Brand Voice Customization</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-8 shadow-sm hover:shadow-md transition">
              ...
              <h3 className="text-xl font-semibold mb-3">Audience Analytics</h3>
              <p className="text-gray-600 mb-4">
                Gain deep insights into your audience behavior, preferences, and engagement patterns with our advanced analytics tools.
              </p>
              <ul className="space-y-2 mb-4">
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-black">Demographic Analysis</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-black">Engagement Tracking</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            ...
            <div className="bg-gray-50 rounded-xl p-8 shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600 mb-4">
                End-to-end management of your social media campaigns, from planning and scheduling to optimization and reporting.
              </p>
              <ul className="space-y-2 mb-4">
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-black">Automated Scheduling</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                ...
                <li className="flex items-center">
                  ...
                  <span className="text-black">Performance Reporting</span>
                </li>
              </ul>
            </div>
          </div>
